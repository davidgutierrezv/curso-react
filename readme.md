...
| 2.1   | [JavaScript Avanzado – Funciones de Manipulación de Arrays y Objetos](clases/clase-02/clase-02.1.md) | `map`, `filter`, `reduce`, `find`, `some`, `every`, Spread Operator, Ejercicios prácticos. |
| 2.2   | [JSX, Props y Hooks](clases/clase-02/clase-02.2.md)       | Introducción a JSX, Uso de Props y composición de componentes, Introducción a hooks: `useState`, `useEffect`, `useCallback`, `useMemo`, `useContext`, Ejercicios prácticos. |
